 ...
 */
public class GeneralInitApiResponse implements CommonResponse {
    ...
    public GeneralInitApiResponse() {
    }

    public GeneralInitApiResponse(String title, String subtitle, String phone, String email, String copyright, String copyrightFrom) {
        this.title = title;
